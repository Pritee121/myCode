...
SECRET_KEY = 'django-insecure-0zu@fby49*%ote03=85jecd4syw*bvan6fry@)vqlsjw&nw7uy'
...
DATABASES = {
    'default': {
        ...
        'HOST': 'localhost',  # Set to the MySQL server address. Use 'localhost' or an IP address.
